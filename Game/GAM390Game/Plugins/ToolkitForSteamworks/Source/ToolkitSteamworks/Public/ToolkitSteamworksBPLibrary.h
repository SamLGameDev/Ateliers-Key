...
class UToolkitSteamworksBPLibrary : public UBlueprintFunctionLibrary
{
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Running on Steam Deck", Keywords = "Heathen Toolkit Steamworks AppId App"), Category = "Heathen's Toolkit|Steamworks|App")
	static bool IsSteamRunningOnSteamDeck();

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Running in VR", Keywords = "Heathen Toolkit Steamworks AppId App"), Category = "Heathen's Toolkit|Steamworks|App")
    ...
    UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get User Int Stat (Game Server)", Keywords = "Heathen Toolkit Steamworks Server"), Category = "Heathen's Toolkit|Steamworks|Steam Game Server")
    static FServerStatIntValue SteamServerGetUserIntStat(int64 user, FString apiName);

    UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get User Float Stat (Game Server)", Keywords = "Heathen Toolkit Steamworks Server"), Category = "Heathen's Toolkit|Steamworks|Steam Game Server")
    ...
    UFUNCTION(BlueprintCallable, meta = (DisplayName = "Set User Int Stat (Game Server)", Keywords = "Heathen Toolkit Steamworks Server"), Category = "Heathen's Toolkit|Steamworks|Steam Game Server")
    static bool SteamServerSetUserIntStat(int64 user, FString apiName, int32 value);

    UFUNCTION(BlueprintCallable, meta = (DisplayName = "Set User Float Stat (Game Server)", Keywords = "Heathen Toolkit Steamworks Server"), Category = "Heathen's Toolkit|Steamworks|Steam Game Server")
    ...
    UFUNCTION(BlueprintCallable, meta = (DisplayName = "Update User Average Rate Stat (Game Server)", Keywords = "Heathen Toolkit Steamworks Server"), Category = "Heathen's Toolkit|Steamworks|Steam Game Server")
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Activate to Lobby Invite Dialog", Keywords = "Heathen Toolkit Steamworks Overlay"), Category = "Heathen's Toolkit|Steamworks|Overlay")
	static void SteamActivateGameOverlayInviteDialog(int64 lobbyId);

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Activate to Remote Play Together Dialog", Keywords = "Heathen Toolkit Steamworks Overlay"), Category = "Heathen's Toolkit|Steamworks|Overlay")
	static void SteamActivateGameOverlayRemotePlayTogetherInviteDialog(int64 lobbyId);

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Activate to Game Invite Dialog", Keywords = "Heathen Toolkit Steamworks Overlay"), Category = "Heathen's Toolkit|Steamworks|Overlay")
	static void SteamActivateGameOverlayInviteStringDialog(FString ConnectionString);
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Friend Persona State", Keywords = "Heathen Toolkit Steamworks Friends"), Category = "Heathen's Toolkit|Steamworks|Friends")
	static UEPersonaState SteamGetFriendPersonaState(int64 SteamID);
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Steam Connect Command Line Value", Keywords = "Heathen Toolkit Steamworks Friends Invite"), Category = "Heathen's Toolkit|Steamworks|Friends")
	static FString SteamGetConnectCommandLineValue();
	...
	static bool SteamSimpleGenerateItems(TArray<FItemTypeCount> items, TArray<FString> readProperties, FItemResultsCallback callback);
	...
	static FInventoryResult SteamGenerateItems(TArray<FItemTypeCount> items);
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Item Count", Keywords = "Heathen Toolkit Steamworks Inventory"), Category = "Heathen's Toolkit|Steamworks|Inventory")
	static void SteamGetItemCount(UInventoryItemDataAsset* Item, int32 DesiredCount, TArray<FItemCount>& ItemCounts, int32& TotalFound, bool& Success);
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Connect Lobby Command Line Value", Keywords = "Heathen Toolkit Steamworks Matchmaking Invite"), Category = "Heathen's Toolkit|Steamworks|Matchmaking")
	static int64 SteamGetConnectLobbyCommandLineValue();
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "UGC Read", Keywords = "Heathen Toolkit Steamworks Remote Storage Cloud Save"), Category = "Heathen's Toolkit|Steamworks|Remote Storage")
	static TArray<uint8> SteamUGCRead(int64 ugcHandle, int size);
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Number of Subscribed Items", Keywords = "Heathen Toolkit Steamworks Workshop User Generated Content UGC"), Category = "Heathen's Toolkit|Steamworks|Workshop")
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Show Gamepad Text Input", Keywords = "Heathen Toolkit Steamworks Gamepad Text Input Keyboard"), Category = "Heathen's Toolkit|Steamworks|Utilities")
	static bool SteamShowGamepadTextInput(UEGamepadTextInputMode InputMode, UEGamepadTextInputLineMode LineMode, FString Description, int32 MaxChar, FString ExistingText);

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Show Floating Gamepad Text Input", Keywords = "Heathen Toolkit Steamworks Gamepad Text Input Keyboard"), Category = "Heathen's Toolkit|Steamworks|Utilities")
	static bool SteamShowFloatingGamepadTextInput(UEFloatingGamepadTextInputMode KeyboardMode, int32 PositionX, int32 PositionY, int32 Width, int32 Height);

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Start VR Dashboard", Keywords = "Heathen Toolkit Steamworks VR"), Category = "Heathen's Toolkit|Steamworks|Utilities")
	static void SteamStartVrDashboard();
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Friend Steam Level", Keywords = "Heathen Toolkit Steamworks User My Me"), Category = "Heathen's Toolkit|Steamworks|Friends")
	static int32 SteamGetFriendSteamLevel(int64 SteamID);
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Session Count", Keywords = "Heathen Toolkit Steamworks Remote Play"), Category = "Heathen's Toolkit|Steamworks|Remote Play")
	static int SteamGetRemotePlaySessionCount();

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Session ID", Keywords = "Heathen Toolkit Steamworks Remote Play"), Category = "Heathen's Toolkit|Steamworks|Remote Play")
	static int SteamGetRemotePlaySessionID(int Index);

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Session User Steam ID", Keywords = "Heathen Toolkit Steamworks Remote Play"), Category = "Heathen's Toolkit|Steamworks|Remote Play")
	static int64 SteamGetRemotePlaySessionUserID(int SessionID);

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Session Client Name", Keywords = "Heathen Toolkit Steamworks Remote Play"), Category = "Heathen's Toolkit|Steamworks|Remote Play")
	static FString SteamGetRemotePlayClientName(int SessionID);
	
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Session Client Form Factor", Keywords = "Heathen Toolkit Steamworks Remote Play"), Category = "Heathen's Toolkit|Steamworks|Remote Play")
	static UEDeviceFormFactor SteamGetRemotePlayClientFormFactor(int SessionID);

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Session Client Resolution", Keywords = "Heathen Toolkit Steamworks Remote Play"), Category = "Heathen's Toolkit|Steamworks|Remote Play")
	static bool SteamGetSessionClientResolution(int SessionID, UPARAM(ref) int32& Width, UPARAM(ref) int32& Height);

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Send Remote Play Invite", Keywords = "Heathen Toolkit Steamworks Remote Play"), Category = "Heathen's Toolkit|Steamworks|Remote Play")
	static bool SteamSendRemotePlayTogetherInvite(int64 SteamID);
};